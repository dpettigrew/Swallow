...
class RequestTests: XCTestCase {
    ...
    func test_parameters_encodedInBodyAsPercentEncoding() {
        ...
        let stringValue = NSString(data: encodedData!, encoding: String.Encoding.utf8)!
    ...
    func test_setBody_overwritesExistingBodyData() {
        ...
        let stringValue = NSString(data: encodedBody!, encoding: String.Encoding.utf8)!
        let components = stringValue.componentsSeparatedByString("=")
    ...
    func test_urlRequestValue_parametersInBody(_ method: Request.Method) {
        ...
        let body = NSString(data: request.urlRequestValue.httpBody!, encoding: String.Encoding.utf8)
...
func ELTestAssertURLQueryEqual(_ url: URL, parameters: [String: String]) {
