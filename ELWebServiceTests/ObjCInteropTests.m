...
- (NSHTTPURLResponse *)mockResponse {
    return [[NSHTTPURLResponse alloc] initWithURL:[URL URLWithString:@"foo"] statusCode:200 HTTPVersion:nil headerFields:nil];
}
...
- (void)test_responseObjC_handlerGetsCalled {
    ...
    [task responseObjC:^ObjCHandlerResult *(NSData *data, URLResponse *response) {
        [expectation fulfill];
        return nil;
    }];
...
- (void)test_responseJSONObjC_receivesHandlerResult {
    ...
    WebService *service = [[WebService alloc] initWithBaseURLString:@"foo"];
    ServiceTask *task = [service GET:@"bar"];
    [task responseJSONObjC:^ObjCHandlerResult *(id json, URLResponse *response) {
    ...
    NSHTTPURLResponse *response = [[NSHTTPURLResponse alloc] initWithURL:[URL URLWithString:@"foo"] statusCode:200 HTTPVersion:nil headerFields:nil];
